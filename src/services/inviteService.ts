 ...
 */
export async function upsertInvite(inviteData: {
  code: string;
  serverUid: bigint;
  inviterUid: bigint;
  channelUid: string;
 ...
 */
export async function markDeleted(code: string, deleterUid?: bigint): Promise<void> {
  try {
 ...
 */
export async function recordInviteUsage(inviteCode: string, userUid: bigint): Promise<void> {
  try {
 ...
 */
export async function getActiveInvites(serverUid: bigint): Promise<invite[]> {
