...
export class ReactionService {
     ...
     */
    static async addReactionRole(messageId, reaction, roleId) {
        try {
     ...
     */
    static async removeReactionRole(messageId, reaction) {
        try {
     ...
     */
    static async removeAllReactionRoles(messageId) {
        try {
            const result = await prisma.reaction_role.deleteMany({
     ...
     */
    static async getRoleForReaction(messageId, reaction) {
        try {
     ...
     */
    static async getReactionRoles(messageId) {
     ...
     */
    static async hasReactionRoles(messageId) {
