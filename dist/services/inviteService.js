...
export class InviteService {
     ...
     */
    static async markDeleted(code, deleterUid) {
        try {
     ...
     */
    static async recordInviteUsage(inviteCode, userUid) {
        try {
     ...
     */
    static async getActiveInvites(serverUid) {
     ...
     */
    static async getInviteStats(serverUid) {
